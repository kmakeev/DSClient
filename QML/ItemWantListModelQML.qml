    ...
    Rectangle {
        ...
        MouseArea {
         ...
         //       idCollectionModel.getInstance(index);
                ...
                wantlist.positionViewAtIndex(index, ListView.Beginning)
   ...
   /*             Text {
    ...
    /*            Text {
        ...
        TextButton {
            ...
            anchors { bottom: background.bottom; bottomMargin: 5
                      horizontalCenter: parent.horizontalCenter}
            opacity: recipe2.detailsOpacity
            text: "Delete   "

            onClicked: {
                if (idWantlistModel.deleteReleaseFromWantlist(index))
                        {  console.log("Release is deleate!") }
                else {  console.log("Releases is not deleate") }
            }
        }
